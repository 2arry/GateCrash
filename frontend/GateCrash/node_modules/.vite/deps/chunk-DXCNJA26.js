...
var PACKAGE_VERSION = "1.29.1";
var TARGETED_RPC_VERSION = "1.49.0";
...
var _Transaction = class _Transaction2 {
  constructor() {
    ...
    this.object = createObjectMethods(
      (value) => {
        ...
        return inserted ? { $kind: "Input", Input: __privateGet5(this, _data).inputs.indexOf(inserted), type: "object" } : __privateMethod3(this, _Transaction_instances, addInput_fn).call(this, "object", typeof value === "string" ? {
          $kind: "UnresolvedObject",
  ...
  static fromKind(serialized) {
    ...
    __privateSet5(tx, _inputSection, __privateGet5(tx, _data).inputs);
    __privateSet5(tx, _commandSection, __privateGet5(tx, _data).commands);
    return tx;
  }
  /**
  ...
  static from(transaction) {
    ...
    __privateSet5(newTransaction, _inputSection, __privateGet5(newTransaction, _data).inputs);
    __privateSet5(newTransaction, _commandSection, __privateGet5(newTransaction, _data).commands);
  ...
  add(command) {
    if (typeof command === "function") {
      ...
      const txResult = createTransactionResult(__privateGet5(this, _data).commands.length - 1);
...
runPlugins_fn = async function(plugins, options) {
  ...
  await createNext(0)();
  __privateSet5(this, _inputSection, __privateGet5(this, _data).inputs);
  __privateSet5(this, _commandSection, __privateGet5(this, _data).commands);
};
...
var JSONRpcTransport = class extends Experimental_CoreClient {
  ...
  async verifyZkLoginSignature(options) {
    const result = await __privateGet6(this, _jsonRpcClient).verifyZkLoginSignature({
      bytes: options.bytes,
...
*/
//# sourceMappingURL=chunk-DXCNJA26.js.map
